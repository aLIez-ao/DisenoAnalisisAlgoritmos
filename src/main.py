...
if __name__ == "__main__":
    ...
    funciones = {
        ...
        "suma_digitos_iterativo": lambda: ejecutar_suma_digitos_iterativo(datos["numero_grande"]()),
        "mcd_iterativo": lambda: ejecutar_mcd_iterativo(datos["numero_grande"](), datos["numero_grande"]()),
        
        # Algoritmos recursivos
        "suma_digitos_recursivo": lambda: ejecutar_suma_digitos_recursivo(datos["numero_grande"]()),
        "mcd_recursivo": lambda: ejecutar_mcd_recursivo(datos["numero_grande"](), datos["numero_grande"]()),
        
        # Algoritmos de ordenamiento
        "ordenamiento_mergesort": lambda: ejecutar_mezcla(),
        "ordenamiento_quicksort": lambda: ejecutar_quicksort(),
    }

    # -------------------------------
    # Ejecutar algoritmo elegido
    # -------------------------------
    algoritmo_ejecutar = "mcd_iterativo"
